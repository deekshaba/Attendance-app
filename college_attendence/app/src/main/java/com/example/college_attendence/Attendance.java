    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(Attendance.this,attendance_info.class);
        ...
        Backendless.Persistence.of(student1.class).find(queryBuilder, new AsyncCallback<List<student1>>() {
            ...
            public void handleResponse(List<student1> response) {
                ...
                adapter= new student1_adapter(Attendance.this,Startapplication.student1);
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                Toast.makeText(Attendance.this, "error!!"+fault.getMessage(), Toast.LENGTH_SHORT).show();
                showProgress(false);
            }
        });
