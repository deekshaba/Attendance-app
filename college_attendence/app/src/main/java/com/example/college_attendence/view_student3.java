...
public class view_student3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(view_student3.this,studentinfo.class);
        ...
        Backendless.Persistence.of(student.class).find(queryBuilder, new AsyncCallback<List<student>>() {
            ...
            public void handleResponse(List<student> response) {
                ...
                adapter= new student_adapter(view_student3.this,Startapplication.students);
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                Toast.makeText(view_student3.this, "error!!"+fault.getMessage(), Toast.LENGTH_SHORT).show();
                showProgress(false);
            }
        });
